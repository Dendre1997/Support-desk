    ...
    <>
      ...
      <section className="form">
        ...
        <form onSubmit={onSubmit}>
          ...
          <select name="product" id="product" value={product} onChange={(e) => e.target.value ? setProduct(e.target.value) : 'iPhone'}>
          ...
          <div className="form-group">
            <label htmlFor="description">Descrioption of the issue</label>
